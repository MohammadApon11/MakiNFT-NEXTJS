      ...
      <div className={CollectionCardsStyles.collection_card_group}>
        ...
        >
          <img
            ...
            alt=""
          />
          <div className={CollectionCardsStyles.collection_card_sub_image_group}>
            <img
          ...
          <div className={CollectionCardsStyles.collection_card_progress}>
            <div className={CollectionCardsStyles.collection_card_single_progress}>
              <img
        ...
        <div
          className={`${CollectionCardsStyles.collection_card} ${CollectionCardsStyles.left_one_s} ${!loadMore ? "block" : "hidden"}`}
        >
          <img
            className={CollectionCardsStyles.collection_card_image}
            src="images/commonCard1/card-7.jpg"
        ...
        <div
          className={`${CollectionCardsStyles.collection_card} ${CollectionCardsStyles.two_hide_480_359_under_358} ${CollectionCardsStyles.left_half_s} ${!loadMore ? "block" : "hidden"}`}
        >
          <img
            className={CollectionCardsStyles.collection_card_image}
            src="images/commonCard1/card-1.jpg"
        ...
        <div
          className={`${CollectionCardsStyles.collection_card} ${CollectionCardsStyles.one_hide_1024_769} ${CollectionCardsStyles.right_one_s} ${!loadMore ? "block" : "hidden"}`}
        >
          <img
            className={CollectionCardsStyles.collection_card_image}
            src="images/commonCard1/card-3.jpg"
