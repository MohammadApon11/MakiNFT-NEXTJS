      ...
      <div className={activityCardStles.activity_card_container}>
        <div className={activityCardStles.card_left}>
          <div className={activityCardStles.activity_card_group}>
              ...
              <div className={activityCardStles.card_profile}>
                ...
                <div className={activityCardStles.activity_card_description}>
                  ...
                  <div className={activityCardStles.card_small_text}>
                    ...
                    <span className={activityCardStles.card_opacity}>From</span>
                    <span className={activityCardStles.card_color}>
                      @Alex_Tomas
                    </span>
                  </div>
            ...
            <div
              className={`${activityCardStles.activity_card} ${
                activityCardStles.right_one_s
              }`}
            >
              <div className={activityCardStles.card_profile}>
                <img
                ...
                />
                <div className={activityCardStles.activity_card_description}>
                  <h3 className={activityCardStles.card_name}>Marry Morgan</h3>
                  <span className={activityCardStles.card_opacity}>
                    Unfollowd You{" "}
                  </span>
                  <div className={activityCardStles.card_timing}>
            ...
            >
              <div className={activityCardStles.card_profile}>
                ...
                <div className={activityCardStles.activity_card_description}>
                  ...
                  <span className={activityCardStles.card_opacity}>for </span>
                  <span className={activityCardStles.card_color}>0.44ETH</span>
                  <div className={activityCardStles.card_timing}>
                    <i>
                      <FontAwesomeIcon icon={faClock} />
                    </i>
            ...
            <div
              className={`${activityCardStles.activity_card} ${
                activityCardStles.one_hide_1024_769
              } ${activityCardStles.right_one_s}`}
            >
              <div className={activityCardStles.card_profile}>
                <img
            ...
            <div
              className={`${activityCardStles.activity_card} ${
                activityCardStles.one_hide_1400_1201
              } ${activityCardStles.left_one_s}`}
            >
              <div className={activityCardStles.card_profile}>
                <img
                ...
                <div className={activityCardStles.activity_card_description}>
                  ...
                  <span className={activityCardStles.card_opacity}>for </span>
                  <span className={activityCardStles.card_color}>0.78ETH {" "}</span>
                  <span className={activityCardStles.card_opacity}>from </span>
                  <span className={activityCardStles.card_color}>
                    @Ales_Tomas
                  </span>
          ...
          <LoadMoreBtn loadMore={loadMore} setLoadMore={setLoadMore} title={"activity"} />
        </div>
        <div
