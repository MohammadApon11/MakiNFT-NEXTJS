  ...
  return (
    <section className={SingleItemCardsStyles.single_item_card_container}>
      <div className={SingleItemCardsStyles.single_item_header}>
        <h1 className={SingleItemCardsStyles.live_auctions_title}>
          Live Auctions
        </h1>
        <Link
          href={"/live-auctions"}
          className={SingleItemCardsStyles.single_item_explore_btn}
        >
      ...
      <div className={SingleItemCardsStyles.single_item_card_group}>
        <Link
          href="singleitem"
          className={SingleItemCardsStyles.single_item_card_area}
        >
          <TransitionWrapper1 index={1}>
            <div className={SingleItemCardsStyles.card_content}>
              ...
              <div
                className={
                  SingleItemCardsStyles.single_item_card_title_container
                }
              >
