        ...
        <RightLeft side={"120%"} duration={0.5}>
          ...
          >
            ...
            <div className={singleItemStyles.single_item_profile_container}>
              ...
              >
                ...
                <div className={singleItemStyles.single_item_profile_flex}>
                  ...
                  <span className={singleItemStyles.created_by}>
                    created_by:
                  </span>
            ...
            <TransitionWrapper1 index={2}>
              <div
                className={
                  singleItemStyles.single_item_progress_and_time_container
                }
              >
                ...
                <div className={singleItemStyles.single_item_time_container}>
                  ...
                  <div className={singleItemStyles.progrss_time}>
                    <span className={singleItemStyles.progress_integer}>
                      24
                    </span>
            ...
            <div className={singleItemStyles.single_item_history_container}>
              <div
                className={singleItemStyles.single_item_history_info_details}
              >
