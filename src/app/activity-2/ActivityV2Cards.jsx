...
import {
  TransitionWrapper1,
  TransitionWrapper2,
} from "@/components/framer-motion/TransitionWrapper";
  ...
  return (
    <section className={activityv2cardStyle.activity_two_container}>
      <div className={activityv2cardStyle.activity_card_container}>
            ...
            <TransitionWrapper1 index={1}>
              ...
              >
                <div className={activityv2cardStyle.card_profile}>
                  ...
                  />
                  <div
                    className={activityv2cardStyle.activity_card_description}
                  >
        ...
        <div
          className={`${activityv2cardStyle.activity_btn_container} ${activityv2cardStyle.card_right}`}
        >
          <div className={activityv2cardStyle.activity_btn_group}>
            ...
            <TransitionWrapper2 index={5}>
              <button
                className={`${activityv2cardStyle.filter_btn} ${activityv2cardStyle.filter_btn_5}`}
              >
                <i>
