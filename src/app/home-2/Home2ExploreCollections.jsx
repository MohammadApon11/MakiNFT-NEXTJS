      ...
      <div className={exploreStyles.home_2_explore_card_group}>
        <TransitionWrapper1 index={1}>
          <div className={`${exploreStyles.home_2_explore_card}`}>
            ...
            <div
              className={exploreStyles.home_2_explore_card_profile_container}
            >
              <div
              ...
              >
                <div className={exploreStyles.home_2_explore_profile_left}>
                  ...
                  >
                    <img
                      className={
                        exploreStyles.home_2_explore_card_profile_image
                      }
                      src="images/profile/profile-3.jpg"
                      alt=""
                    />
                    <div
                      className={exploreStyles.home_2_explore_icon_container}
                    >
                  ...
                  <div
                    className={exploreStyles.home_2_explore_card_description}
                  >
